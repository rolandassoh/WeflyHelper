...
public class CircleProgress extends View {
    ...
    public void setProgress(int progress) {
        ...
        notifyOnCircleProgressListener(progress);
...
//        canvas.drawArc(rectF, 90 - angle, angle * 2, false, paint);
    ...
    public void setOnCircleProgressListener(@NonNull OnCircleProgressListener listener) {
        this.listener = listener;

    }

    public static interface OnCircleProgressListener {
        void onProgressUpdated(int progress);
    }

    public void notifyOnCircleProgressListener(int progress) {
        if (listener != null ){
